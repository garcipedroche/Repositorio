...
public class Teclado {
	...
	/**
	 * Metodo para preguntar si desea repetir.
	 * @param string
	 *            texto que desea mostrar
	 * @return devuelve true si escribes s o S y false si escribes n o N, se
	 *         repite un bucle para otros casos
	 */
	public static boolean continuar(String string) {
		do {
			char c = Teclado.leerCaracter("¿" + string + "?(s/n)");
			if ((c == 's') || (c == 'S'))
				return true;
			if ((c == 'n') || (c == 'N'))
				return false;
